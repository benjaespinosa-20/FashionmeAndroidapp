...
public abstract class StickerView extends FrameLayout {
    ...
    private final static int SELF_SIZE_DP = 150;

    // is StickerText
    private StickerTextInputDialog stickerTextInputDialog;

    private IMakeLookView makeView;

    private int id;


    public StickerView(Context context, IMakeLookView makeView) {
        super(context);
        this.makeView = makeView;
        init(context);
    }

    public StickerView(Context context, StickerTextInputDialog stickerTextInputDialog, IMakeLookView makeView) {
        super(context);
        this.makeView = makeView;
        this.stickerTextInputDialog = stickerTextInputDialog;
        init(context);
    }
        ...
        this.iv_delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if(StickerView.this.getParent()!=null){
                    ...
                    makeView.deletedSticker(StickerView.this);
                }
            }
        });
            ...
            if(view.getTag().equals("DraggableViewGroup")) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if (stickerTextInputDialog != null) {
                            Log.v(TAG, "sticker text view action down");
                            bringToFront();
